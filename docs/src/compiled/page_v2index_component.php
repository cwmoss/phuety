...
/**
 * /Users/rw/dev/playground/phuety/docs/src/pages/v2index.phue.php ~ 
 */

class page_v2index_component extends component {
    public string $uid = "page_v2index---ZKgoYE";
    public bool $is_layout = true;
    public string $name = "page_v2index";
    public string $tagname = "page.v2index";
  ...
  <script>
    ...
    //    return /Users/rw/dev/playground/phuety/docs/src/pages/v2index.phue.php ~ ;
    // }
}
